...
//CODE HERE
const compareNums = (num, num2) => (num > num2 ? num : num2);
console.log(compareNums(67, 4));
...
//CODE HERE
const bestMovie = (movie) => `${movie} is the bst movie ever!!!`;
